...
export default function Button({ title, icon, ghost, compact, disabled, loading, small, fontSize = 22, color = 'white', backgroundColor = 'var(--theme-color)', onClick = () => { }, marginBottom = 14, borderColor = null }: Props) {
