      ...
      en: {
        translation: {
          ...
          settings: {
            ...
            showLogicErrors: 'Show logic errors',
            showSolutionErrors: 'Show solution errors',
      ...
      es: {
        translation: {
          ...
          settings: {
            ...
            showLogicErrors: 'Mostrar errores lógicos',
            showSolutionErrors: 'Mostrar errores por solución',
